...
import com.example.apple.chatemotion.emoji.emotin.utils.LogUtils;
...
public class EmotionKeyboard {
     ...
     * @return
     */
    public EmotionKeyboard bindToEditText(EditText editText, Showface showface) {
        mEditText = editText;
    ...
    public boolean interceptBackPress1() {
        if (mEmotionLayout.isShown()) {
            return true;
        }
        return false;
