package com.example.apple.chatemotion.emoji.emotin.view;
...
public class EmojiIndicatorView extends LinearLayout {
    ...
    public void initIndicator(int count){
        ...
        for (int i = 0 ; i<count ; i++){
            ...
            if (i == 0){
                v.setBackgroundResource(R.drawable.emoji_cursor_20);
            }else{
                v.setBackgroundResource(R.drawable.emoji_cursor_1);
            }
            mImageViews.add(v);
            this.addView(v);
        }
    ...
    public void playByStartPointToNext(int startPosition,int nextPosition){
        ...
        ViewNext.setBackgroundResource(R.drawable.emoji_cursor_20);
        ViewStrat.setBackgroundResource(R.drawable.emoji_cursor_1);
    }
